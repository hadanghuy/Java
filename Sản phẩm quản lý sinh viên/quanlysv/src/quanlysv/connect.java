...
public class connect {
    ...
    public connect() throws ClassNotFoundException, SQLException{
        ...
        //Tạo kết nối
        String url="jdbc:mysql://localhost:3306/qlsv";//Đường dẫn vào Data Base
    ...
    public void UserInsert(int id, String name, String passwd , int isAdmin, int isOpen) throws SQLException {
     ...
     public void StudentUpdate(int id, String name, String classID, int gender, String date, String dt, String address) throws SQLException {
        Statement sta = this.conn.createStatement();
        String sql1 = "Update sinhvien set hoten='" + name + "' , malop='"+ classID +"' , gioitinh ="+gender+" where masv =" + id + "";
        String sql2 = "Update sinhvien set ngaysinh='" + date + "' , dantoc ='"+dt+"' , quequan ='"+address+"' where masv =" + id + "";
        sta.executeUpdate(sql1);
        sta.executeUpdate(sql2);
    }
    public void StudentInsert(int id, String name, String classID, int gender, String date, String dt, String address) throws SQLException {
        Statement sta = this.conn.createStatement();
        String sql1 = "Insert sinhvien values(" + id + ",'" + name + "','" + classID + "', "+gender+", '"+date+"', '"+dt+"', '"+address+"' )";
        sta.executeUpdate(sql1);
    }
    ...
    ResultSet rs = conn.getData("sinhvien");
    while(rs.next())
     {
